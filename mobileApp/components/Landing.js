...
const styles = StyleSheet.create({
  ...
  btnPrimary: { backgroundColor: '#3b82f6', paddingHorizontal: 24, paddingVertical: 14, borderRadius: 12, elevation: 4 },
  btnText: { color: '#fff', fontWeight: '700', fontSize: 16 },
  btnOutline: { borderWidth: 1, borderColor: '#e2e8f0', backgroundColor: '#fff', paddingHorizontal: 24, paddingVertical: 14, borderRadius: 12 },
  btnOutlineText: { color: '#0f172a', fontWeight: '600', fontSize: 16 },
  mockupContainer: { width: width - 48, height: 200, borderRadius: 16, overflow: 'hidden', borderWidth: 1, borderColor: '#e2e8f0', backgroundColor: '#fff' },
  ...
  featureCard: { flexDirection: 'row', marginBottom: 24, alignItems: 'center' },
